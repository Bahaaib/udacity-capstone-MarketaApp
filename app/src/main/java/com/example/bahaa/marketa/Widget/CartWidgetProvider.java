...
public class CartWidgetProvider extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager, int appWidgetId) {
        ...
        // Set the CartWidgetService intent to act as the adapter for the GridView
    ...
    public void onEnabled(Context context) {
        ...
        //context.registerReceiver(this, new IntentFilter("android.appwidget.action.APPWIDGET_UPDATE2"));
